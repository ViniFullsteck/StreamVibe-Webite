export const features = [
  {
    ...
    text: "Com o StreamVibe , tarefas tediosas são coisa do passado. Automação e processos inteligentes elevam sua produtividade a novos patamares. É como tomar uma xícara extra de café, mas sem a agitação.",
    button: {
  ...
  },
  {
    ...
    text: "A segurança dos seus dados é nossa prioridade. Com criptografia de ponta e controles de privacidade robustos, o StreamVibe ajuda a manter suas informações seguras e trancadas com mais força que Fort Knox.",
    button: {
...
export const details = [
  ...
  },
  {
    ...
    title: "Motor em nuvem ultra rápido",
  },
  {
    id: "3",
...
export const faq = [
  {
    id: "0",
    question: "Quão fácil é configurar o StreamVibe?",
    answer:
  ...
  {
    id: "2",
    question: "Com que frequência vocês adicionam novo conteúdo?",
    answer:
      "Com certeza! Não só você pode atualizar seu plano a qualquer momento, mas também recebe um desconto proporcional, garantindo o máximo valor para sua assinatura.",
  },
  {
  ...
  {
    id: "5",
    question: "O que acontece quando fico sem armazenamento?",
    answer:
      "Com certeza! Não só você pode atualizar seu plano a qualquer momento, mas também recebe um desconto proporcional, garantindo o máximo valor para sua assinatura.",
  },
  {
...
export const plans = [
  {
    ...
    features: [
      "100MB de armazenamento na nuvem",
      "100+ modelos de prompts",
      "5 projetos",
      "Suporte 24/7",
    ],
  ...
  },
  {
    ...
    features: [
      "Todas as funcionalidades do plano Turbo",
...
export const testimonials = [
  {
    ...
    comment:
      "O suporte ao cliente do StreamVibe é incomparável! Eles são como meus super-heróis da tecnologia, sempre presentes quando preciso deles.",
  },
  {
    id: "1",
    name: "Mark Erixon",
    ...
    comment:
      "No início eu estava cético, mas agora não consigo imaginar nossas operações de conteúdo sem ele. É tão impactante.",
  },
  {
    id: "2",
    name: "Melanie Hurst",
  ...
  },
  {
    ...
    comment:
      "O recurso de análise é como ter um vidente pessoal. Tem sido fundamental para orientar nossas decisões de negócios.",
  },
  {
    id: "4",
    name: "Becky Snider",
    ...
    comment:
      "Mudei para o Xora no mês passado e já estou vendo resultados. A melhor decisão para nossa equipe!",
  },
  {
    id: "5",
    name: "Jim Bradley",
